...
<template>
  ...
  <!-- 使用template插槽来自定义骨架屏模板 -->
    ...
    <div class="page">
      <a-pagination show-quick-jumper :total="this.total" :show-total="total => `共 ${total} 个结果`" :show-size-changer="false" :page-size="20" @change="onChange" :locale="{ jump_to: '跳转到', page: '页' }"/>
...
div[class$=Page]{
    width: 80px; height: 25px;text-align: center;color: white;border-radius: 5px;
      line-height:25px;  background: linear-gradient(to right, #40a9ff, #1890ff);margin: 0 5px;
    }
div[class=pages]{
